...
urlpatterns = [
    ...
    path('patient_detail/check', d_views.patient_detail_check, name="patient_detail_check"),
    # path('patient_detail/send_medication_notif', d_views.send_medication_notif,
    # name="send_medication_notification"), path('patient_detail/send_questionnaire_notif',
    # d_views.send_questionnaire_notif, name="send_questionnaire_notification"),
